...
async function main() {
  ...
  await prisma.interesse.deleteMany({}); // <-- ADICIONADO
  ...
  // Buscar categorias
  const categoriaArte = await prisma.categoria.findUnique({
    where: { nome: "Arte e Cultura" },
  });
  const categoriaGastronomia = await prisma.categoria.findUnique({
    where: { nome: "Gastronomia" },
  });
  const categoriaTecnologia = await prisma.categoria.findUnique({
    where: { nome: "Tecnologia" },
  });
  const categoriaEsportes = await prisma.categoria.findUnique({
    where: { nome: "Esportes" },
  });
  const categoriaUniversitario = await prisma.categoria.findUnique({
    where: { nome: "Universitário" },
  });
  ...
  await prisma.evento.create({
    data: {
      ...
      imagemEvento: {
        create: [{ url: "https://images.sympla.com.br/6900f9d61ea49-lg.png" }],
      },
    },
  });
  ...
  await prisma.evento.create({
    data: {
      ...
      imagemEvento: {
        create: [
          {
            url: "https://static.wixstatic.com/media/b04a79_53c83948f0d94320b60649dd77dd171d~mv2.png/v1/fill/w_959,h_478,al_c,q_90,usm_0.66_1.00_0.01,enc_avif,quality_auto/b04a79_53c83948f0d94320b60649dd77dd171d~mv2.png",
          },
        ],
      },
    },
  ...
  await prisma.evento.create({
    data: {
      ...
      local:
        "Teatro SESIMINAS Uberaba - Praça Frei Eugênio, 231, Uberaba - MG  ",
      preco: 80.0,
      id_organizador: admin.id_usuario,
      ...
      imagemEvento: {
        create: [
          {
            url: "https://assets.bileto.sympla.com.br/eventmanager/production/3dgv3heskkfkgjeaqibqikmn3tb2pgkhp9t8hame7gn6vslt2emmiu5vgcj8s0k9jk6cfin8oqq8d6fb98jaidt6a3rp5lq857d62fn.webp",
          },
        ],
      },
    },
  ...
  await prisma.evento.create({
    data: {
      ...
      descricao:
        "Seu Halloween não precisa mais ser sozinho: A Festa do Sim é um convite pra quem quer reviver aquele beijo e uma segunda chance pra quem demorou demais na hora de tomar iniciativa.",
      ...
      imagemEvento: {
        create: [
          {
            url: "https://imagedelivery.net/O7_Y6XDx1JJ1t21C0rdfjQ/79364e4f-34a0-41c6-db81-26c9ecb56000/perfil",
          },
        ],
      },
    },
  ...
  await prisma.evento.create({
    data: {
      ...
      descricao:
        "Inspirado no filme O Rei do Show, a adaptação do Musical 2025 traz uma narrativa emocionante sobre sonhos, desafios e superação. No palco, a história de um homem que reúne talentos extraordinários para formar um espetáculo inesquecível, e descobre, no caminho, a força da amizade e da persistência.",
      data: new Date("2025-10-28T23:00:00Z"),
      local:
        "Teatro SESIMINAS Uberaba - Praça Frei Eugênio, 231, Uberaba - Minas Gerais",
      preco: 40.0,
      id_organizador: admin.id_usuario,
      id_categoria: categoriaArte!.id_categoria,
      imagemEvento: {
        create: [
          {
            url: "https://assets.bileto.sympla.com.br/eventmanager/production/2kilaqh76uq9n82neadtolh83fk0t2ohprdvom666fvk3vn0a0h5ct6n1rus0p9shkcuglp640tjiqs3d9gvd33ngeqtoia3pvd6j03.webp",
          },
        ],
      },
    },
  ...
  await prisma.evento.create({
    data: {
      ...
      data: new Date("2025-10-31T23:00:00Z"),
      local:
        "Praça Comendador Quintino, 144 - Estados Unidos, Uberaba - MG, 38015-410, Brasil",
      preco: 10.0,
      id_organizador: admin.id_usuario,
      id_categoria: categoriaUniversitario!.id_categoria,
      imagemEvento: {
        create: [
          {
            url: "https://res.cloudinary.com/shotgun/image/upload/c_limit,ar_16:9,w_750/fl_lossy/f_auto/q_auto/c_limit,f_auto,fl_lossy,q_auto,w_1920/v1761581682/production/artworks/Artboard_11-100_mrmyln",
          },
        ],
      },
    },
